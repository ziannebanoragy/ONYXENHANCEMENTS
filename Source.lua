...
function Library:Loader(Config)
    ...
    task.spawn(function()
        pcall(function()
            ...
            Library:Tween(StartText, 1, { TextTransparency = 1 })
            for i, v in ipairs(PosText) do
                Library:Tween(v.Text, 1, { TextTransparency = 1 })
            end
            Library:Tween(Blur, 1, { Size = 0 })
            Library:Tween(BlackFrame, 1, { BackgroundTransparency = 1 })
            task.wait(1.1)
